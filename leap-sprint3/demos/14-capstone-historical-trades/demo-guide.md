# Demo: Module 14 — Capstone, Extending the Schema for Historical Trade Data

**Duration:** 12 minutes
**Prerequisite:** Module 13's running, loaded mission database.
...
`shared/mission-brief.md` flagged as coming later, back in Module 07.
...
Narration: this is entirely Modules 08-09's skills again, an entity, foreign keys, `CHECK`

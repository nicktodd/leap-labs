...
are independent - checking `dave` has no bearing on checking `erin`. The Angular
week's login-attempts lockout check is the opposite case: it deliberately needs

...
`/accounts/{id}/orders` endpoint is protected - the Spring week's `SecurityConfig` rejects any request
without a valid JWT.

By Module 7, the auth service (real registration, real password hashing, real Postgres

...
Recap the pattern from the Pipelines and Data weeks: GitHub Copilot Chat is a learning aid, not a
...
- *"What's a cleaner way to write this nested if/elif chain?"* - then decide for yourself whether
  the suggestion is actually clearer, or just different (the same judgement call from earlier weeks)

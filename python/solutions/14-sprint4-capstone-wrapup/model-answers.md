...
gaps, in the same spirit as earlier weeks' equivalent wrap-up modules.
...
- **Charts follow Module 10's honest-axis rule** even under capstone time pressure - a bar chart
  with a truncated y-axis, done in a rush, is exactly the mistake this week spent a whole

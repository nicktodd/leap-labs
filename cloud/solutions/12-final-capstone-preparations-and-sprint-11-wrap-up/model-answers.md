...
Run for real, auditing the whole week's accumulated AWS activity at once:
...
- The Acceptance Tests stage includes a check specific to the capstone feature, not only the
  Angular week's original login flow.

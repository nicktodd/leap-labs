# Lab 12 - Final Capstone Preparations & Wrap-up
...
3. Identify whether your capstone extension lives in the existing mission-service
...
6. Extend the Acceptance Tests stage with at least one Playwright check that exercises your
   capstone feature specifically, not just the Angular week's original login flow.

### Part 3: Prepare your showcase narrative

7. Write down one specific example of a Copilot suggestion during your own work (this week or
   your capstone project) that needed correcting - what was wrong with it, and how did you catch it before
   trusting it?
...
The mission brief says this week's deployment steps "apply to your capstone extension

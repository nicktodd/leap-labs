...
VPC-scoped). A working `ng build` of `mission-ui` from the Angular week.
...
week uses Standard exclusively - `mission-ui`'s static build is accessed constantly by anyone

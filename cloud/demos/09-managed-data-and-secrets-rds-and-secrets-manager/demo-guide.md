...
a subnet group and a security group, just like everything else this week has provisioned.
...
private subnets everything else in this week has used:
...
least-privilege instinct as every security group rule so far this week.

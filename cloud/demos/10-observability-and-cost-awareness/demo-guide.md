...
costing?" (cost awareness). Both get answered today using data this week's earlier modules
...
every task this week has run, going back to Module 7. A cluster with no tasks currently running
...
`bytesScanned: 22693`). This is the same log group used throughout this week; nothing new had
...
Rather than estimate what this week's modules have cost, ask AWS directly:
...
These numbers are small because every billed resource this week created was torn down again
...
*asking AWS what actually happened*, the same discipline this week has used for every other

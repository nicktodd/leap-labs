...
This is the last technical lab of this week. It has two parts: finishing the integration test
...
- Completed an end-to-end integration test that builds and runs BOTH the mission service and the
  ...
  across all three
- Reflected on the week as a whole - which design decisions from Days 1-2 survived unchanged
...
## Part 2 - Week Wrap-up (Written)

The Java week's Module 14 asked you to trace design decisions from a first draft through to what
you actually built. This week's mission brief asked the same question in its Non-Goals section.
Answer it now, in **3-5 sentences per point**:
...
2. **The mission brief's "What Changes, and What Doesn't" section** claimed the Java week's
   business logic wouldn't need rewriting. Was that true? Point at the actual file (`domain/OrderValidator`
   or similar) as evidence.
3. **Name the one deliberate simplification** Module 11 made (portfolio valuation) and explain,
   in your own words, why it was a reasonable trade-off for a training week rather than a

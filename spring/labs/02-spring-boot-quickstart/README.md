...
Create `src/main/java/com/neueda/leap/mission/service/MissionServiceApplication.java`:
...
Create `src/main/java/com/neueda/leap/mission/service/HelloController.java`:

...
## Coming from the Java week

This week takes the Order Processing & Settlement Engine you built during the Java week and turns
it into a real, deployable microservice. The core domain logic - `OrderValidator`, `HoldingUpdater`,

# Module 03 Lab - Commands Walkthrough (Instructor Reference)

```bash
cd starter
mvn clean package
# target/pipelines-greeter-app-0.1.0.jar now exists

docker build -t pipelines-greeter-app .
docker images
# REPOSITORY               TAG      IMAGE ID       SIZE
# pipelines-greeter-app    latest   ...            ~180MB

docker run -d --name greeter pipelines-greeter-app
docker ps
# CONTAINER ID   IMAGE                    ...   NAMES
# ...            pipelines-greeter-app   ...   greeter

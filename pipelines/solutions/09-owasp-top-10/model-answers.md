...
## Which categories return in the Node.js/NestJS week

**A01 (Broken Access Control), A05 (Injection), and A07 (Authentication Failures)** get a full
dedicated deep-dive in the Node.js/NestJS week. Everything above is intentionally conceptual breadth for this

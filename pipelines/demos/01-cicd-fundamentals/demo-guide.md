# Demo: Module 01 - CI/CD Fundamentals

**Duration:** 8 minutes
**Prerequisite:** `sample-pipeline-log.txt` open or projected on screen. No hands-on tooling
needed yet, Module 02 covers running Jenkins directly.
...
Full deployment automation comes with Docker and later this week.
...
reporting failure the moment something breaks. Module 02 opens Jenkins itself and runs a
pipeline like this one live.

## Key message

CI/CD isn't a specific tool, it's a discipline: every change gets built, tested, and packaged
automatically and consistently. Jenkins is one tool (the one we use this week) that

...
watch this part rather than run it themselves, full hands-on cloud work comes
...
- **Version control**: infrastructure changes go through the same PR review as the Foundations
  week's Modules 6/7, a second pair of eyes before anything real changes
...
exercise. A named AWS CLI profile (`aws configure --profile pipelines-sandbox`) is the safer

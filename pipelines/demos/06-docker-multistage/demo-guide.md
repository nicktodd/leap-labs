...
Narration: Module 03 covered containers vs VMs and images vs containers, and had you
write a minimal single-stage Dockerfile, copying in a jar you'd already built locally with
Maven. Module 03 also showed (but didn't have you write) a multi-stage example, using GenAI
just to explain what it did. Module 04 then used that same single-stage pattern to containerise
...
Module 3's Dockerfile got you a working container. This deeper dive gets you one that's

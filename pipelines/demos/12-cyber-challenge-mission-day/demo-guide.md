# Demo: Module 12 - Cyber Challenge, Mission Day

**Duration:** This is a facilitator run-of-show for a full day, not a single demo.
**Prerequisite:** Teams already formed earlier this week, the `starter/` codebase pushed to a repository each
...
this week or in the Foundations week: Agile ceremonies (the Foundations week's Modules 1-2), the PR workflow (the Foundations week's Module 6),
review etiquette (the Foundations week's Module 7), OWASP recognition (Module 09), Secure Code Warrior practice (Module 10), and
...
goal for the day (the Foundations week's Module 2 skill, applied for real, under time pressure this time).
...
Teams continue: fixing, committing via the Foundations week's Module 6 PR workflow, and preparing their
...
Run the Foundations week's Module 2 format, but pointed at the whole week, not just today. This feeds directly
into Module 13's wrap-up.
...
- **Don't rescue teams too early.** Getting stuck and working through it under time pressure is
  ...
  exercise would.
- **The six vulnerabilities span categories already covered this week** (A01, A02, A03, A06,
...
- **Presentations are the part most teams under-prepare for.** Budget real time for it in the
  schedule, and hold the 5-minute limit firmly, this is itself a practised skill (the Foundations week's Module 7's
...
that this week's separate skills (agile process, Git hygiene, OWASP recognition, secure

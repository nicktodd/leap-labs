# Module 04 Lab - Containerising the Project Skeleton
...
- That skeleton committed to your team repository using the branching strategy you agreed in
  the Foundations week's Module 9
...
- Your team repository from the Foundations week's Module 9, with its branching strategy documented
- Access to your Linux Docker host - connect in your preferred way, and
...
1. As a team, create a branch for this work, following whatever branch naming your Foundations
   week's Module 9 strategy calls for (or `feature/docker-skeleton` if it doesn't specify one).
...
5. Write a minimal, single-stage Dockerfile for it, based on what you practised in Module 03.
...
8. Merge it into `main` following whatever process your team agreed in the Foundations week's
   Module 9 (a quick
...
12. As a team, create a `Jenkinsfile` at the root of the repository with three stages:
    ...
    against the image you just built). Base this on the Jenkinsfile syntax from Modules 01, 02,
    and 05, you don't need anything more complex than that for a skeleton.

# Module 02 Lab - Introduction to Jenkins
...
- Access to this week's Jenkins instance
...
- Your own Pipeline job in Jenkins, pointing at your own copy of the
  [`starter/`](starter) project from this lab, pushed to your GitHub repository from the
  Foundations week's Module 5

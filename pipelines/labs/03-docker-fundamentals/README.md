# Module 03 Lab - Docker Fundamentals
...
- The
  [`unfamiliar-multistage-dockerfile.txt`](../../demos/03-docker-fundamentals/unfamiliar-multistage-dockerfile.txt)
  from the demo
...
7. Build the image: `docker build -t pipelines-greeter-app .`
...
- You have a written explanation (in your own words) of containers vs VMs, and images vs
  containers.
- `docker images` shows your `pipelines-greeter-app` image.

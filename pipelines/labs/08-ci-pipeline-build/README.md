...
merge to `main`, the piece that makes the Foundations week's Module 6 branch protection meaningful in practice.
...
watch the PR's automatic build go red, this is the Foundations week's Module 6's "failing pipeline protects main" made

...
- **Module 03 (Docker Fundamentals)**: containers vs VMs, images vs containers, a minimal
  single-stage Dockerfile, and a multi-stage example GenAI explained but you didn't write
- **Module 04 (Containerising the Project Skeleton)**: used that single-stage pattern to
...
- The [`starter/`](starter) folder from this lab, cloned or copied onto the Linux host - a copy
  of this week's project skeleton with its original single-stage `Dockerfile`

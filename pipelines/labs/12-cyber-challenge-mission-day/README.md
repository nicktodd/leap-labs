# Module 12 Lab - Cyber Challenge: Mission Day
...
- Submitted your work via Git with proper branching and commit hygiene (the Foundations week's
  Module 6)
...
- A team repository, with your agreed branching strategy from the Foundations week's Module 9
...
agree a one-sentence sprint goal for the day (the Foundations week's Module 2), and a rough allocation of who
...
4. Commit the fix via a proper branch and PR (the Foundations week's Module 6), reviewed by a
   teammate (the Foundations week's Module 7)
...
Run a Start / Stop / Continue retro (the Foundations week's Module 2) covering the whole week, not just today.
Bring your notes to Module 13.
...
- You have Start / Stop / Continue notes from your retro, ready for Module 13.

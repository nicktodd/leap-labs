...
Stand up your own broker (skip if you already have `kafka-missionstream` running from the demo and
...
Open `src/main/java/com/neueda/leap/mission/stream/SimpleProducer.java` and complete the three TODOs:

...
**Do not do this inside this labs repo.** Create a separate, throwaway
...
git init
mkdir -p src/main/java/com/neueda/leap/mission/stream
```

Create `src/main/java/com/neueda/leap/mission/stream/PaymentGateway.java` with this content (the

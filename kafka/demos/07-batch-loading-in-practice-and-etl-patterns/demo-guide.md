...
```bash
java -cp "target/classes;$(cat cp.txt)" com.neueda.leap.mission.stream.NaiveLoader
java -cp "target/classes;$(cat cp.txt)" com.neueda.leap.mission.stream.NaiveLoader
```
...
```bash
java -cp "target/classes;$(cat cp.txt)" com.neueda.leap.mission.stream.IdempotentLoader
java -cp "target/classes;$(cat cp.txt)" com.neueda.leap.mission.stream.IdempotentLoader
```

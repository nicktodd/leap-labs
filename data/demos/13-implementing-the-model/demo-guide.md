# Demo: Module 13 - Implementing the Data Model in Postgres

**Duration:** 10 minutes
**Prerequisite:** Module 09's hardened DDL for the mission model. A Postgres instance to run it
against. No new concepts today, this is execution.

## Part 1: Framing the task (1 min)

Narration: Modules 07-09 designed, diagrammed, and hardened a schema entirely on paper (or in a
...
Narration: nothing new here, this is Module 02's `\c` and `\i` again, and Module 09's DDL,
...
(shared across this whole week), rather than inventing new ones, this is deliberately the same
...
`CHECK` constraint from Module 09 is actually doing its job, not just sitting unused in the
DDL.

# Module 15 - Week 2 Wrap-up & Assessment Notes (Data)
...
- [x] 1NF/2NF/3NF with concrete examples - `07-rdbms-modelling-part1/normalisation-analysis.md`
- [x] ER diagram for mission model - text ER in `08-er-diagrams/mission-model-draft.sql`; formal diagram to be drawn on paper or in a tool during the session
...
- [x] Five-step structured problem-solving - `10-structured-problem-solving/answers.md` (clarify, identify entities, decide modelling changes, sketch approach, validate)
- [x] Classifying new scenarios - `11-nosql-overview/answers.md` (key-value, columnar, document)
- [x] Snowflake storage/compute separation - `12-snowflake-overview/BLOCKED.md` (conceptual answer included; lab blocked without Snowflake account)

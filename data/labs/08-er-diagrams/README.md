# Module 08 Lab - ER Diagram and First-Draft DDL for the Mission Model
...
- Your team's normalized table list from Module 07
...
1. Using Module 07's table list (`clients`, `model_portfolios`, `instruments`,
...
6. Don't worry about indexes, `CHECK` constraints, or anything beyond `NOT NULL` on obviously
   required columns yet, that's Module 09.
...
7. Re-read `shared/mission-brief.md`. For each of the four numbered requirements in the brief,
   ...
   to anything, that's a gap worth fixing now, before Module 09 builds on top of it.

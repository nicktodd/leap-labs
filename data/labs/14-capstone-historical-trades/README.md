# Module 14 Lab - Capstone: Extending the Schema for Historical Trade Data
...
- Your team's running, loaded mission database from Module 13
...
3. Load sample trade history for at least three clients, consistent with their existing
   `client_holdings` rows from Module 13 (their net trades should roughly explain their current
   holding).
...
This is the last hands-on lab of this week's Data content. Module 15 wraps up and prepares you for Friday's

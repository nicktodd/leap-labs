# Module 15 Lab - Instructor Notes
...
- **Mission model**: "every team member can explain a table they didn't build" is the single
  most important item on this list, it's what Module 14 was actually testing for.
...
| ER diagram doesn't match the running database | Schema evolved (Module 09, 13) without updating the diagram | Have them regenerate or hand-correct the diagram before Friday |
| client_trades and client_holdings don't reconcile | A data entry error in Module 14's sample data | Run the net-position query together and find the discrepancy |
| Only the "builder" can explain a table | Module 14's team-understanding step was rushed or skipped | Spend remaining time doing it properly now, this is the one gap not to let slide |
...
the Foundations and Pipelines weeks' equivalent modules.

...
- Two real Docker builds, using Sprint 6 and Sprint 8's existing Dockerfiles unchanged.
...
kind of cleanup this sprint has applied manually to every other billed resource (S3 buckets,

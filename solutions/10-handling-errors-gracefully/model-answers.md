...
polluting every method signature up the call stack. This is the same trade-off Sprint 5 made with
its own domain exceptions: checked exceptions model "the caller must decide what to do right

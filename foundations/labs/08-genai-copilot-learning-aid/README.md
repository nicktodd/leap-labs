# Module 08 Lab - GitHub Copilot as a Learning Aid
...
- The two snippet files from the demo:
  [`unfamiliar-jenkinsfile-snippet.txt`](../../demos/08-genai-copilot-learning-aid/unfamiliar-jenkinsfile-snippet.txt)
  and
  [`unfamiliar-dockerfile-snippet.txt`](../../demos/08-genai-copilot-learning-aid/unfamiliar-dockerfile-snippet.txt)

# Module 10 Lab - Week 1 Wrap-up & Assessment Prep
...
- Identified and closed any personal skills gaps
- Peer-checked a partner's setup against the checklist below

## Setup

- Everything from Modules 01-09, nothing new
...
- [ ] Docker Desktop is installed and the daemon is reachable (e.g. `docker
      ps`) - verified this week, used in depth starting next week
- [ ] GitHub account is signed in and has access to the LEAP organisation
- [ ] GitHub Copilot Chat is available in IntelliJ
- [ ] Access to the team's Jenkins instance is confirmed (login only - Jenkins itself starts
      next week)

### Agile & Ceremonies (Modules 01-02)

- [ ] Can name the three Scrum roles and explain what each owns
- [ ] Can explain INVEST and apply it to judge whether a backlog item is ready
- [ ] Can describe the difference between Sprint Review and Sprint Retrospective

### Git & GitHub (Modules 03-05)
...
### PR & Code Review (Modules 06-07)

- [ ] Can show a merged PR with a Conventional Commit-style title and a description covering
      what, why, and how to verify
- [ ] Can show at least one real review comment they left on a partner's PR or repository
- [ ] Can explain what a branch protection rule does and why it matters
...
3. For every unticked item, note it down specifically, not "Git stuff", but "couldn't show a
   real merge conflict they'd resolved."
...
Friday: guest speaker, Weekly Knowledge Check (MCQ), Week 1 Assessment, and Group Retro.

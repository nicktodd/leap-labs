# Module 10 Lab - Team Repo & Branching Strategy Setup
...
- Every team member has completed Modules 04-06 individually
...
1. As a team, agree a repository name: `<team-name>-foundations-project`.
...
5. As a team, revisit the trunk-based vs Gitflow-style comparison from Module 05.
...
8. One team member creates a `README.md` at the root of the repository with:
   - A one-line project name/description (a placeholder is fine, the real project starts
     properly later in the programme)
...
Your trainer will check each team's repository against this checklist before the week's end.

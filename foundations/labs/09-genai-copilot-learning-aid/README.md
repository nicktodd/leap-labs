# Module 09 Lab - GitHub Copilot as a Learning Aid
...
- The two snippet files from the demo:
  [`unfamiliar-jenkinsfile-snippet.txt`](../../demos/09-genai-copilot-learning-aid/unfamiliar-jenkinsfile-snippet.txt)
  and
  [`unfamiliar-dockerfile-snippet.txt`](../../demos/09-genai-copilot-learning-aid/unfamiliar-dockerfile-snippet.txt)
...
If you finish early, try asking Copilot to explain a different section of the Jenkinsfile or
Dockerfile snippets you haven't covered yet, and critique that explanation too.

# Module 04 Lab - Git Branching Strategies
...
1. Copy `starter/` to a working location, rename it `foundations-branching-lab`, and initialise it
...
11. For your Scrum team (roughly 6-8 people, one repo, releasing frequently), decide which
    ...
    reasoning again in Module 09 when your team sets up its real repository.

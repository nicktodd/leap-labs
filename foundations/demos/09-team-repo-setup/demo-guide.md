# Demo: Module 09 - Team Repo & Branching Strategy Setup

**Duration:** 8 minutes
**Prerequisite:** none new, this reuses everything from Modules 03-05. No new tooling.

## Part 1: Framing the task (2 min)

Narration: this module introduces no new commands. Everything you need, you already have from
Modules 03, 04, and 05: `git init`/commit basics, branching and merging, and connecting a local
...
individually in Module 05.

## Part 3: Reaching a branching strategy decision as a team (2 min)

Narration: point back to Module 04's criteria: team size, release cadence, and how much
...
This module is where Modules 03-05 stop being lab exercises and become how your team actually

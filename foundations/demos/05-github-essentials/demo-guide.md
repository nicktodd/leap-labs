# Demo: Module 05 - GitHub Essentials
...
On github.com: **New repository**, name it `foundations-demo-app`, leave it empty (no README, no
`.gitignore` from GitHub, we already have our own).

```bash
git remote add origin https://github.com/<org>/foundations-demo-app.git
git remote -v
...
```bash
git clone https://github.com/<org>/foundations-demo-app.git foundations-demo-app-clone
cd foundations-demo-app-clone
git log --oneline
```
...
week (Module 6), but the underlying data flow is exactly this.

# Demo: Module 06 - Advanced Git: Pull Requests & Repo Hygiene
...
Narration: this week got you comfortable with the mechanics: Module 03 was commits and staging,
Module 04 was branching and merging (including resolving a conflict by hand), Module 05 was
connecting to a remote and using push and pull, deliberately stopping short of Pull Requests.
Today picks up exactly where Module 05 left off.
...
Narration: this week's Module 03 covered the basics (`target/`, `.idea/`). Today's addition:

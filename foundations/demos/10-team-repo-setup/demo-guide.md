# Demo: Module 10 - Team Repo & Branching Strategy Setup

**Duration:** 8 minutes
**Prerequisite:** none new, this reuses everything from Modules 04-06. No new tooling.

## Part 1: Framing the task (2 min)

Narration: this module introduces no new commands. Everything you need, you already have from
Modules 04, 05, and 06: `git init`/commit basics, branching and merging, and connecting a local
...
```text
New repository -> name it <team-name>-foundations-project -> do not initialise with a README
...
individually in Module 06.

## Part 3: Reaching a branching strategy decision as a team (2 min)

Narration: point back to Module 05's criteria: team size, release cadence, and how much
...
This module is where Modules 04-06 stop being lab exercises and become how your team actually

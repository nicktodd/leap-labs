# Module 09 Lab - Example Critique (Instructor Reference)
...
artifacts (from the Pipelines week onward). Worth adding that nuance rather than accepting the answer as complete.

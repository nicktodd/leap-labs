# Module 07 Lab - Walkthrough (Instructor Reference)
...
# conflict markers appear in Main.java, exactly like Module 05
...
- Partners can articulate *why* the second PR conflicted and the first didn't (same underlying
  mechanic as Module 05: two branches diverged from the same commit and touched the same line).

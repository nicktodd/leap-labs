# Module 03 Lab - Model Sprint Plan (Instructor Reference)
...
3. **Drill into a category's transactions** (3 points)
   ...
   - List reuses the existing transaction detail view from Module 02's PS-101
...
- Teams that write "Build the Insights dashboard" as a single story, that's PS-105 from Module
  02 all over again, not sized for a sprint.

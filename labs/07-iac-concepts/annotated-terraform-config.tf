# Add a comment above each block below explaining, in your own words, what it does and why it
# matters. Source: demos/07-iac-concepts/sample-terraform-config.tf

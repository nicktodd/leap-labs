# Module 13 Lab — Implement and Load the Mission Data Model

## Objectives

By the end of this lab you will have:

- Applied Modules 07-09 to implement the mission data model in a real Postgres database
...
1. Create a new database for the mission model, and run your team's complete Module 09 DDL
   against it.
...
Module 10's "drift" report, now that real data exists to run it against.

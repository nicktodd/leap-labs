# Demo: Module 09 — RDBMS Modelling Part 2, Keys, Indexes & Constraints

**Duration:** 14 minutes
**Prerequisite:** Module 08's first-draft DDL for the mission model.
...
you've already used since Module 08; today's about the *other* things a schema needs beyond
just structure.
...
## Part 5: Closing Module 08's gap (2 min)

Narration: Module 08 left a known gap, no table for a client's actual current holdings. Today's
...
A schema with correct structure (Module 08) but no constraints will happily store bad data,

# Demo: Module 08 — ER Diagrams, Translating Requirements into Schemas

**Duration:** 14 minutes
**Prerequisite:** Module 07's normalized table list for the mission model. Pen/paper or a
...
exactly what Module 07 did in words. Point at the notation legend on the slides:
...
Take Module 07's final table list and draw it as a proper ER diagram together: `clients`,
...
beyond what the primary keys create automatically. Module 09 adds all of that properly, today
is about getting the shape right first.

## Key message

An ER diagram is a formal, shared language for exactly the thinking Module 07 already did.

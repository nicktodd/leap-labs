...
// A simple Java class modelling a single trade. Fields are private (encapsulation)
// with public getters - Module 2 covers why that matters as a design decision, not
// just syntax.
public class Trade {

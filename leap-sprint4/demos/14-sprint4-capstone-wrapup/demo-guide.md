# Demo: Module 14 — Capstone: Building the Analytics Dashboard & Sprint 4 Wrap-up

**Duration:** 15 minutes
**Files:** `dashboard_demo.py`

## Part 1: One script, everything this sprint taught (5 min)
...
This module has almost no new content on purpose — it exists to prove Sprint 4's pieces

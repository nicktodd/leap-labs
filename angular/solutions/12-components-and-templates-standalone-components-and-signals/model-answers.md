...
- **`interface Holding`**: plain TypeScript, no Angular import needed - Module 8
...
modifies `holdings` - a new method, a service call in Module 13, anything - would also have

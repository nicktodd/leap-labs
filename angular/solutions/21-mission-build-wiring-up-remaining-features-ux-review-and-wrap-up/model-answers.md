...
- `npx ng test --watch=false` after the fix: **15 passed (15)** - unchanged from Module 20.
- `npx playwright test` after the fix: **4 passed** - Module 20's login-journey suite,
  unchanged.
...
**What a passing test suite does and doesn't guarantee**: Module 20's suite passing the whole
...
- which is a genuinely different kind of test from anything Module 20 wrote, not a stricter

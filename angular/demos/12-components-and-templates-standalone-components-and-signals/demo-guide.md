# Module 12 Demo Guide - Components & Templates: Standalone Components & Signals

**Duration:** 30 minutes
**Prerequisite:** Module 11's `mission-ui` project, `ng serve` working.

Module 10 read Angular code. Module 11 scaffolded a real project. Today builds the first real
...
just this component), and a `.spec.ts` (Module 20's unit test starting point, untouched
...
`interface Holding` is plain TypeScript, straight from Module 8 - nothing
Angular about it.
...
Angular syntax layered on top of it, exactly as Module 10 named it: `@for`/`@empty` for the
...
connecting the two. Nothing here needed a service, DI, or HTTP - Module 13 is exactly about

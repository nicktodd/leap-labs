...
**Duration:** 18 minutes
**Prerequisite:** none - this is this week's actual starting point.

Today builds the page that Modules 2-6 will style, animate, and wire up to a real
...
Module 5 will show what happens when this isn't enough (custom rules, custom
...
writing less. Modules 2, 5, and 6 build directly on top of this same file: CSS styles it,
JavaScript makes it interactive, `fetch()` wires it to this week's auth stub's real
`/auth/login` endpoint.

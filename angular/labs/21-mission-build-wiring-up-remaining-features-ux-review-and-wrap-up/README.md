# Lab 21 - Mission Build: Wiring Up Remaining Features, UX Review & Wrap-up

## Setup

Your own `mission-ui`, wherever you left it at the end of Module 20. Same running backends.

## Task

### Part 1: Find a real integration gap

Twenty modules built `mission-ui` piece by piece, each verified on its own. Today's job is to
...
2. `npx playwright test` - confirm the Module 20 login-journey suite still passes.
...
Module 20's test suite was passing the whole time this gap existed. What does that tell you
...
- What was the single most useful thing you learned this week - not the flashiest, the one

# Lab 11 - Angular Project Structure, Dev Server & Build Tooling
...
demand, pinned to Angular 21 (this week's required version, paired with TypeScript 5.9) so
...
This is the actual Angular application the rest of this week builds, module by module, so pick
...
`.html` files Modules 1-6's page needed (one, total, the whole time). Given that Angular apps
...
explicitly, even though Module 10's own example did. Why would a real Angular codebase written

# Module 3 Lab - JavaScript Fundamentals: Syntax, Variables, Functions & Control Flow
...
```bash
cd labs/03-javascript-fundamentals-syntax-variables-functions-and-control-flow
...
either way, and Module 4's refactor doesn't fix this, on purpose.

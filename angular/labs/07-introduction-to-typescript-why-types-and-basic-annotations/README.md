# Lab 7: Introduction to TypeScript - Why Types & Basic Annotations
...
exact typo from Module 4's "Objects vs Java Records" comparison) and rerun
`npx tsc report.ts --strict --noEmit`. What does `tsc` say, and how is that different
from what would have happened if this were still Module 4's plain JavaScript?
